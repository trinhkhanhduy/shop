...
function Staff() {
  ...
  const editStaff = async (idnv) => {
    try {
      ...
      resetEdit({
        ...
        matkhaunv: resEmployee[0]?.mat_khau_nv,
  ...
  const columns = [
    {field: "id_nv", headerName: "ID", width: 70, headerAlign: "center", align: "center"},
    {field: "ten_nv", headerName: "Tên Nhân Viên", width: 180, headerAlign: "center"},
    {field: "email_nv", headerName: "Email", width: 250, headerAlign: "center"},
    {field: "sdt_nv", headerName: "Số Điện Thoại", width: 130, headerAlign: "center", align: "center"},
    {field: "ngay_sinh_nv", headerName: "Ngày Sinh", width: 130, headerAlign: "center", align: "center"},
    {field: "ten_cv", headerName: "Chức Vụ", headerAlign: "center", align: "center", width: 165},
    {
      field: "hanh_dong",
  ...
  const rows = listEmployee?.map(({id_nv, ten_nv, email_nv, sdt_nv, ngay_sinh_nv, ten_cv}, idx) => ({
    id: idx,
    id_nv: id_nv,
    ten_nv: ten_nv,
    email_nv: email_nv,
  ...
  return (
    <div className="px-4">
      <div>
        <button onClick={handleOpenAdd} className="px-4 py-2 text-white bg-lime-600 rounded-lg shadow-lg">
          Thêm nhân viên
        </button>
        <Modal
        ...
        >
          <Fade in={openAdd}>
            <Box sx={style}>
              <p className="my-4 text-center text-[25px] font-bold">Thêm nhân viên</p>
      ...
      <div className="mt-5">
        <div style={{height: 600, width: "100%"}}>
          ...
          >
            <Fade in={openEdit}>
              <Box sx={style}>
                <p className="my-4 text-center text-[25px] font-bold">Sửa nhân viên</p>
                    ...
                    <div className="w-[45%]">
                      ...
                      <div className="mb-2">
                        ...
                        <input
                          ...
                          className="mt-1 py-1 px-2 w-full px2 border-2 border-slate-500 rounded-lg"
                          type="text"
                          {...registerEdit("matkhaunv", {required: true})}
                        />
                      </div>
                      <div className="mb-2">
                        <p>Số điện thoại</p>
